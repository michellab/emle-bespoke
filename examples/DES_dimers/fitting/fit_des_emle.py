...
from emle_bespoke.lj._interaction_energy import (
    InteractionEnergyLoss as _InteractionEnergyLoss,
)
...
def main():
    ...
    loss_group.add_argument(
        ...
        type=str,
        default="uniform",
        choices=["uniform", "boltzmann", "non-boltzmann"],
    ...
    try:
        ...
        # Fit LJ potential
        top_off = reference_data["topology"]
        ...
        for batch_idx, batch in enumerate(progress_bar):
            ...
            results["e_lj"].append(e_lj.detach().cpu().numpy() * _HARTREE_TO_KJ_MOL)
        ...
        # Convert LJ energies to tensors
        e_lj = _torch.tensor(results["e_lj"], device=device, dtype=_torch.float64)

        # For memory management, delete EMLE model and empty cache
        del emle, lj_potential
